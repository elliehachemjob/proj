...
import './flowConfigurationRegistration.mini.styles.css';

// make Container marginLeft to  0 or add props/redux etc

function FlowConfigurationRegistration() {
  ...
  const [flowConfigurationDone, setFlowConfigurationDone] = useState(false);
  const BasicIcon = () => {
  ...
  const handleSaveConfigurationChange = () => {
    setFlowConfigurationDone(true);
  };
  return (
    <div style={{ marginTop: -60 }}>
      <div
        className='newWrapper-flowConfiguration'
        style={{
      ...
      <div className='saveButton-wrapper-flowConfiguration'>
        <Button
          onClick={handleSaveConfigurationChange}
          className='button-fieldsAdd'
          name={
            <div className='wrapper-addIcon-applicationFlow'>
              <Label
                label={
                  <div className='newFlow-applicationFlow'>
                    <SaveIcon />
                    <Label textTransform='none' label='Save Configuration' />
                  </div>
                }
...
export default FlowConfigurationRegistration;
