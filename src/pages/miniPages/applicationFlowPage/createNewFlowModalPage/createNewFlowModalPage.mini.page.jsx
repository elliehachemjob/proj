...
function CreateNewFlowModalPage(props) {
  ...
  return (
    ...
    >
      <div className='wrapper-main-flowStepsModal'>
        <div className='wrapper-flowStepsModal'>
          <div className='labelWrapper-flowStepsModal'>
            <Label label='Add Flow Name' className='header-basics' />
          </div>
          <div className='inputWrapper-flowStepsModal'>
            <Input
              label='AMConfig-IB'
              style={{
                width: 165,
...
export default CreateNewFlowModalPage;
